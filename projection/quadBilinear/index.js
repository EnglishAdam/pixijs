...
//add sprite itself
var containerSprite = new PIXI.projection.Sprite2s(new PIXI.Texture.fromImage('../../required/assets/SceneRotate.jpg'));
...
var bunny = new PIXI.projection.Sprite2s(new PIXI.Texture.fromImage('../../required/assets/flowerTop.png'));
