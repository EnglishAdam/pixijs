...
// load spine data
PIXI.loader
    .add('pixie', '../../required/assets/Pixie.json')
    .load(onAssetsLoaded);
...
function onAssetsLoaded(loader,res) {
    ...
    background = PIXI.Sprite.fromImage('../../required/assets/iP4_BGtile.jpg');
    background2 = PIXI.Sprite.fromImage('../../required/assets/iP4_BGtile.jpg');

    foreground = PIXI.Sprite.fromImage('../../required/assets/iP4_ground.png');
    foreground2 = PIXI.Sprite.fromImage('../../required/assets/iP4_ground.png');
